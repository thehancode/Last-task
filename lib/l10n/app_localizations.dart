...
abstract class AppLocalizations {
  ...
  /// ICU date pattern used for task status timestamps older than 30 days.
  ///
  /// In en, this message translates to:
  /// **'MM-dd-yyyy'**
  String get completionDatePattern;

  /// Compact suffix appended to the number of days since a task status change.
  ///
  /// In en, this message translates to:
  /// **'d'**
